...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org2blog-test-system" '("org2blog--")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ox-wp" '("ox-wp-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org2blog" '("org2blog")))
